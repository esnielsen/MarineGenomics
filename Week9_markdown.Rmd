...
#read in the data 
q<-read.table("MarineGenomicsData/Week9/stru_k3.qopt")
...
#read in the data 
q<-read.table("MarineGenomicsData/Week9/stru_k7.qopt")
...
2. Make a multipanel plot showing K=2, K=4, and K=6. You can set the parameters of the plot screen to allow three rows and one column using par(mfrow=c(3,1)) 
