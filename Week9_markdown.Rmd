...
```{r echo=T}
q<-read.table("MarineGenomicsData/Week9/structure_outs/stru_k6.qopt")

#read in the population information file located in the bam.filelist
pop<-read.table("MarineGenomicsData/Week9/bam.filelist")
...
q2<-read.table("MarineGenomicsData/Week9/structure_outs/stru_k2.qopt")
q4<-read.table("MarineGenomicsData/Week9/structure_outs/stru_k4.qopt")
q6<-read.table("MarineGenomicsData/Week9/structure_outs/stru_k6.qopt")
