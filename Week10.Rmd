...
The next logical step when you've identified a candidate SNP is to ask "what's the function of the gene region near the candidate SNP?" This seems like a straight forward question, as the main goal of many of these studies is to indentify the genetic basis of a given phenotype. However, as we dig into this question we will see that it is rather opaque. First we need to condsider whether the SNP we identifeid is "the" SNP itself that is under selection or is the SNP associated through physical linkage (aka hitchiking), with the gene or gene region that is under selection?

This question can be adressed through whole genome resequencing and identification of regions with reduced heterozygosity which indicate patterns of linked-selection. This is reviewed more fully [here](http://cooplab.github.io/popgen-notes/#the-effect-of-linked-selection-on-patterns-of-neutral-diversity)
