...
Let's navigate into the Week 7 directory and take a lookat the vcf file:
...
Open R Studio. The first thing we need to do is download a few different packages. You only need to do this the first time you use each package on your machine.
...
install.packages("BiocManager","vcfR","pcadapt","devtools") # type "yes" when prompted
...
>     <summary>
>
>     [Solution]{style="color: goldenrod;"}
>
>     </summary>
>
>     <p>
